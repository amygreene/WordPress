...
Description: This plugin is used when there are words, words expressions or sentences to be explained via tooltips in the posts or pages of your wordpress blog. <a href="admin.php?page=explanatory-dictionary/explanatory-dictionary-manage.php">Settings</a>
Version: 3.0.2
...
function explanatory_dictionary_load(){
    ...
    $explanatory_dictionary_table_name = $wpdb->prefix."explanatory_dictionary";
    $explanatory_dictionary_plugin_prefix = "explanatory_dictionary_";
    $explanatory_dictionary_version = "3.0.2";
