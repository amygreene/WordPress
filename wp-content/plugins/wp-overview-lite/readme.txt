...
Tags: wordpress, memory, limit, bump, wp, overview, lite, show, usage, dashboard, load, footer, sLa, sLaNGjI
...
NEWS - 2012 Major Release are Coming Soon ... Stay Tuned! 

Thanks to [RavanH](http://profiles.wordpress.org/users/RavanH) for this [security fix](http://wordpress.org/support/topic/plugin-wp-overview-lite-dashboard-footer-memory-usage-request-dashboard-widget-not-for-subscribers)
 ...
 * [wpmu.org](http://wpmu.org/your-complete-guide-to-troubleshooting-wordpress/)
 * [johnoverall.com](http://www.johnoverall.com/wordpress-excessive-overloading-of-your-server-solving-the-wp_cron-php-resource-issue/)
 * [item-9.com](http://item-9.com/trouble-updating-wordpress-or-wp-plugins-try-asking-your-host-to-increase-your-php-memory-limit/)
 * [computer-acquisti.com](http://computer-acquisti.com/blog/wp-overview-lite-consumo-memoria-ram-wordpress/)
 * [wpdude.com](http://wpdude.com/plugin-review-wpoverview/)
 * [searchwordpressplugins.com](http://searchwordpressplugins.com/plugin/wp-overview-lite-mu/)

[PHP memory indicator](http://wordpress.org/extend/plugins/php-memory-indicator/) the first (clone) plugin derived directly from WP Overview (lite) Cool!
...
RESOLVED [Dashboard Widget Not For Subscribers](http://wordpress.org/support/topic/plugin-wp-overview-lite-dashboard-footer-memory-usage-request-dashboard-widget-not-for-subscribers): [try it here](http://downloads.wordpress.org/plugin/wp-overview-lite.zip) (WP 3.0.1 or later required to run)
The regular subscribers get to see the same info of Admin and Super Admin on multi-site installations. For most it's just confusing, for others it's too much info on server background and it might be considered a security risk for sites where user registration is open to everyone. The beta solution implemented, for now, only on the development release is to allow only the admin, and super admin on multi-site installations, to see the dashboard widget, and everyone to see memory load footer. Thanks to [RavanH](http://profiles.wordpress.org/users/RavanH/) for this [security fix](http://wordpress.org/support/topic/plugin-wp-overview-lite-dashboard-footer-memory-usage-request-dashboard-widget-not-for-subscribers).
= Admin Bar: Frontend PHP Error Message =
RESOLVED [Admin Bar: Frontend PHP Error Message](http://wordpress.org/support/topic/plugin-wp-overview-lite-dashboard-memory-load-usage-admin-bar-frontend-php-error-message)
...
= Development Release =
[Version 2012.0625-BUGFIX.1728-DEVELOPMENTAL](http://downloads.wordpress.org/plugin/wp-overview-lite.zip) (WP > 3.2+)
= Warning Notice =
Version 2011.0723.2011 was silently updated on 2012-06-25.
...
= 2010.0118.1801 =
* Improved compatibility with WPMU 2.9.1.1
...
Want you to try MS (MU~LTI-SITE) version now? [Download](http://wordpress.org/extend/plugins/wp-overview-lite-ms/) it from here!

== WPMU Release of WP Overview (lite) ==

Want you to try MU (WPMU) version now? [Download](http://wordpress.org/extend/plugins/wp-overview-lite-mu/) it from here!
...
== Links ==
[Credit Link](http://slangji.wordpress.com/)
== Support ==
[Support Forums Tag](http://wordpress.org/tags/wp-overview-lite/)
== Todo List ==
* Support for:
 ...
 * Full [Tiket #13847](http://core.trac.wordpress.org/ticket/13847) support
 * New Identifications of: Menu, Multisite, Admin Bar, ToolBar
== Translations ==
[Translation Link](http://plugins.trac.wordpress.org/browser/wp-overview-lite/branches/languages/wp-overview-lite.pot)
== Updates ==
[SVN Repo](http://plugins.svn.wordpress.org/wp-overview-lite/) and [Trac Browser](http://plugins.trac.wordpress.org/browser/wp-overview-lite/)
== Thanks ==
Thanks to all keep the [Credit Link](http://slangji.wordpress.com/) or [Donate](http://slangji.wordpress.com/donate/) for this free work :D