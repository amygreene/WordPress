...
<?php
    ...
    public static function repeat_field_set($field_name, $args = array() ) {
        ...
        foreach ( $values['fields'] as $subfield ) {
            ...
            if ( apply_filters('frm_show_normal_field_type', true, $subfield['type']) ) {
                echo FrmFieldsHelper::replace_shortcodes($subfield['custom_html'], $subfield, $args['errors'], $args['form'], array(
                ...
                do_action('frm_show_other_field_type', $subfield, $args['form'], array( 'field_name' => $subfield_name ));
            }
    ...
    public static function repeat_button_html($args, $end) {
        ...
        $triggers .= '<a href="#" class="frm_remove_form_row'. $args['remove_classes'] .'" data-key="'. $args['i'] .'" data-parent="'. $args['parent_field']['id'] .'">'. $args['remove_icon'] . $args['remove_label'] .'</a> ';
        $triggers .= '<a href="#" class="frm_add_form_row'. $args['add_classes'] .'" data-parent="'. $args['parent_field']['id'] .'">'. $args['add_icon'] . $args['add_label'] .'</a>' ."\n";
