...
class FrmProEntriesController{
    ...
    public static function csv( $form_id = false, $search = '', $fid = '' ) {
		...
		//_deprecated require(FrmAppHelper::plugin_path() .'/pro/classes/views/frmpro-entries/csv.php');
...
$('#frm_form_". $id ."_container .frm-show-form').submit(window.frmFrontForm.submitForm);
});
/*]]>*/
</script>";
