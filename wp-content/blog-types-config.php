...
$blog_types[0]['name'] = 'Program/Course site';
$blog_types[0]['nicename'] = 'program';
$blog_types[0]['description'] = 'Program and Course websites';
$blog_types[0]['signup_only'] = 'no';

$blog_types[1]['name'] = 'Individual';
$blog_types[1]['nicename'] = 'individual';
$blog_types[1]['description'] = '';
$blog_types[1]['signup_only'] = 'no';

$blog_types[2]['name'] = 'Group';
$blog_types[2]['nicename'] = 'group';
$blog_types[2]['description'] = '';
$blog_types[2]['signup_only'] = 'no';

$blog_types[3]['name'] = 'Other';
$blog_types[3]['nicename'] = 'other';
