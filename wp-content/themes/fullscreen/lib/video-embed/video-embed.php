...
class GPPVideoEmbedder {
	...
	function getVideoPlayer() {
        ...
        return '<script type="text/javascript" src="' . get_bloginfo('template_directory') . '/js/swfobject.js"></script>
        	    <div id="flvplayer-' . $counter . '"><img src="' . get_bloginfo('template_directory') . '/images/video.jpg"></div>
                <script type="text/javascript">
                	var so = new SWFObject("' . get_bloginfo('template_directory') . '/lib/video-embed/video-player.swf", "swfplayer", "' . $width . '", "' . $height . '", "9", "#000000"); // Player loading
