...
define('TEMPLATE_DOMAIN','solipsus');
////////////////////////////////////////////////////////////////////////////////
// load text domain
////////////////////////////////////////////////////////////////////////////////
...
<li <?php comment_class(); ?> id="comment-<?php comment_ID(); ?>">
			<h3 class="commenttitle"><?php if (function_exists('avatar_display_comments')) { ?>
...
<?php } ?><?php comment_author_link() ?> <?php _e('Said',TEMPLATE_DOMAIN); ?>:</h3>
		<p class="commentmeta">
			<?php _e('on',TEMPLATE_DOMAIN);?> <?php comment_date() ?>
			at <a href="#comment-<?php comment_ID() ?>" title="<?php _e('Permanent link to this comment',TEMPLATE_DOMAIN); ?>"><?php comment_time() ?></a>
