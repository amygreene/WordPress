...
<div id="content" class="widecolumn">
  ...
  <div class="post" id="post-<?php the_ID(); ?>">
    <h2><a href="<?php echo get_permalink($post->post_parent); ?>" rev="attachment"><?php echo get_the_title($post->post_parent); ?></a> &raquo; <a href="<?php echo get_permalink() ?>" rel="bookmark" title="<?php _e('Permanent Link:',TEMPLATE_DOMAIN);?> <?php the_title(); ?>">
      <?php the_title(); ?>
      </a></h2>
    <div class="entry">
      ...
      <p class="postmetadata alt"> <small> <?php _e("This entry was posted",TEMPLATE_DOMAIN); ?>
        ...
        .
        <?php _e("You can follow any responses to this entry through the",TEMPLATE_DOMAIN); ?>
        <?php comments_rss_link('RSS 2.0'); ?> <?php _e('feed',TEMPLATE_DOMAIN);?>.
