...
<h2 id="comments"><?php comments_number(__("Comments",TEMPLATE_DOMAIN), __("One Comment",TEMPLATE_DOMAIN), __("% Comments",TEMPLATE_DOMAIN));  ?>
<?php if ('open' == $post->comment_status) { ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a href="#postcomment" title="<?php _e("Leave a comment",TEMPLATE_DOMAIN); ?>"><span><?php _e("Leave a comment.",TEMPLATE_DOMAIN); ?></span></a>
<?php } ?></h2>
