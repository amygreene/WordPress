...
<div id="header">
	...
	<div id="header-image">
		<?php if (is_home()) { ?><img alt="Header image" src="<?php header_image() ?>" /><?php } else { ?><a title="Return to front page" href="<?php echo get_settings('home'); ?>"><img alt="Header image" src="<?php header_image() ?>" /></a><?php } ?>
	</div>

	<div id="title">
		<?php if (is_home()) { echo $homeTagStart; bloginfo('name'); echo $homeTagEnd; } else { ?><a title="<?php _e("Return to front page",TEMPLATE_DOMAIN); ?>" href="<?php echo get_settings('home'); ?>"><?php echo $homeTagStart; bloginfo('name'); echo $homeTagEnd; ?></a><?php } ?>
		<?php if (get_bloginfo('description') != '') { ?><p id="tagline"><?php echo get_bloginfo('description'); ?></p><?php } ?>
	</div>

	<div id="navigation">
		<ul id="nav-1">
			<li><a title="Return to front page" href="<?php echo get_settings('home'); ?>"><?php _e('Home',TEMPLATE_DOMAIN);?></a></li>
