...
?>
	...
	<?php /* Check if there are posts */
		if ( have_posts() ) {
			...
			// added to support wp-recent-links plugin
			if( function_exists('rp_recentlinks_inline') && !is_single() ) {
				rp_recentlinks_inline(); $linkcounter=0;
			}
	?>
			...
			<div class="entry-head">
				...
				<div class="entry-meta">
					...
					<div class="meta-row">
						...
						<?php /* Comments */ comments_popup_link('0&nbsp;<span>'.__('Comments','redo_domain').'</span>', '1&nbsp;<span>'.__('Comment','redo_domain').'</span>', '%&nbsp;<span>'.__('Comments','redo_domain').'</span>', 'commentslink', '<span class="commentslink">'.__('Closed','redo_domain').'</span>'); ?>
