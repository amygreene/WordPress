...
<div id="content">
  ...
  <?php while (have_posts()) : the_post(); ?>
    <div class="post" id="post-<?php the_ID(); ?>">
      ...
      <div class="meta"><?php _e('by', 'notepad-chaos'); ?> <?php the_author_posts_link(); ?> <?php _e('posted under', 'notepad-chaos'); ?> <?php the_category(', ') ?> |  <?php comments_popup_link(__('No Comments &#187;', 'notepad-chaos'), __('1 Comment &#187;', 'notepad-chaos'), __('% Comments &#187;', 'notepad-chaos')); ?></div>
    </div>
    <?php endwhile; ?>
