	...
	<body <?php body_class(); ?>>
		...
		<div class="big-wrapper">
			...
			<div class="header-cover section bg-dark-light no-padding">
				...
				<div class="header section" style="background-image: url(<?php if (get_header_image() != '') : ?><?php header_image(); ?><?php else : ?><?php echo get_bloginfo('stylesheet_directory') . '/images/header.jpg'; ?><?php endif; ?>);">
