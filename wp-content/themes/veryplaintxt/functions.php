<?php
define('TEMPLATE_DOMAIN','veryplaintxt');
...
define('HEADER_IMAGE_WIDTH', 794); //width is fixed
define('HEADER_IMAGE_HEIGHT', 180);
define('NO_HEADER_TEXT', true );

function veryplain_admin_header_style() { ?>
<style type="text/css">
...
add_custom_image_header('', 'veryplain_admin_header_style');
