...
<?php if ( have_comments() ) : ?>
	...
	<p class="post-comments-rss"><?php _e('You can follow the comments for this article with the',TEMPLATE_DOMAIN);?> <?php comments_rss_link('RSS 2.0'); ?> <?php _e('feed',TEMPLATE_DOMAIN);?>.</p>
