					...
					<div class="post-meta-container">
						...
						<div class="post-meta">
							...
							<?php if( function_exists('zilla_likes') ) zilla_likes(); ?>
								...
								<p class="post-categories"><?php echo get_the_term_list($post->ID,'fungi-category', ' ', ', ', '' ) ?></p>
								<p class="post-categories"><?php echo get_the_term_list($post->ID,'morphology', 'Morphology: ', ', ', '' ) ?></p>
