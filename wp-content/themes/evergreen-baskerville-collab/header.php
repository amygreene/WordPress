...
<html <?php language_attributes(); ?>>
	...
	<body <?php body_class(); ?>>
		...
		<div class="header section small-padding bg-dark bg-image" style="background-image: url(<?php if (get_header_image() != '') : ?><?php header_image(); ?><?php else : ?><?php echo get_stylesheet_directory_uri() . '/images/header.jpg'; ?><?php endif; ?>);">
			...
			<div class="header-inner section-inner">
				<div class="evergreenlogo">
					<a href="http://www.evergreen.edu/"><img src="<?php echo get_bloginfo('stylesheet_directory');?>/images/evergreen-white.svg" alt="The Evergreen State College" /></a>
					</div>
